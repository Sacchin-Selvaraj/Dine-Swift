...
public class AuthExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAuthenticationException(AuthenticationException ex) {
        ErrorResponse errorResponse = new ErrorResponse(
                "Authentication Failed", Collections.singletonList(ex.getMessage())
        );
    ...
    public ResponseEntity<ErrorResponse> handleAccessDeniedException(AccessDeniedException ex) {
        ErrorResponse errorResponse = new ErrorResponse(
                "Access Denied",  Collections.singletonList(ex.getMessage())
        );
...
//    }
    ...
    public ResponseEntity<ErrorResponse> handleCustomAuthenticationException(CustomAuthenticationException ex){
        ErrorResponse errorResponse = new ErrorResponse(
                "User not properly authenticated", Collections.singletonList(ex.getMessage())
        );
        return new ResponseEntity<>(errorResponse, HttpStatus.FORBIDDEN);
    }
    ...
    public ResponseEntity<ErrorResponse> handleTokenException(TokenException ex){
        ErrorResponse errorResponse = new ErrorResponse(
                "Token Exception ", Collections.singletonList(ex.getMessage())
        );
